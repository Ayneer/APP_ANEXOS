...
import MdNotificationsOutline from 'react-ionicons';
import IosAnalytics from 'react-ionicons';
import MdGrid from 'react-ionicons';
                    ...
                    <UncontrolledDropdown>
                        <DropdownToggle className="p-0 mr-2" color="link">
                            <div className="icon-wrapper icon-wrapper-alt rounded-circle">
                                ...
                                <MdGrid color="#3f6ad8" fontSize="23px" icon="md-grid"/>
                            </div>
                        </DropdownToggle>
                    ...
                    <UncontrolledDropdown>
                        <DropdownToggle className="p-0 mr-2" color="link">
                            <div className="icon-wrapper icon-wrapper-alt rounded-circle">
                                ...
                                <MdNotificationsOutline beat={true} color="#d92550" fontSize="23px" icon="md-notifications-outline"/>
                    ...
                    <UncontrolledDropdown>
                        <DropdownToggle className="p-0" color="link">
                            <div className="icon-wrapper icon-wrapper-alt rounded-circle">
                                ...
                                <IosAnalytics color="#3ac47d" fontSize="23px" icon="ios-analytics"/>
                            </div>
                        </DropdownToggle>
                        <DropdownMenu right className="dropdown-menu-xl rm-pointers">
                            <div className="dropdown-menu-header">
